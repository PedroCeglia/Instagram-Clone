...
import com.example.instagramclone.models.Mensagem;
...
public class MensagensAdapter extends RecyclerView.Adapter<MensagensAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        // Se o Nome estiver vazio, ele não sera exibido, o nome so é exibido em grupos
        ...
        // Se existir alguma Url, a imagem sera exibida
        if ( imagem != null ){
            Log.i("ImagemErro", "Tem Imagem");
            Log.i("ImagemErro", imagem);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            nome = itemView.findViewById(R.id.tvNomedoUsuario);
